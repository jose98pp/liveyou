...
async function startServer() {
  ...
  app.get("/api/schedule", async (req, res) => {
    try {
      ...
      // Intentar usar origin del cliente, o en su defecto construirlo basándose en el host del applet
      ...
      // Intentar usar referer del cliente, o en su defecto construirlo basándose en el host del applet
